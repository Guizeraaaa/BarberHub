...
class LoginController extends ChangeNotifier {
  ...
  // Cliente que fez login (usado na tela de agendamento)
  Client? loggedClient;
  ...
  void loginButtonPressed(BuildContext context) {
    if (key.currentState!.validate()) {
      ...
      if (userType == UserType.client) {
        // A tela de compromissos passa a mostrar os agendamentos de quem logou
        context.read<AppointmentController>().currentUserId = loggedClient!.id;
